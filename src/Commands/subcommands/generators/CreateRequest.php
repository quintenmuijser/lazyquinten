...
class CreateRequest extends CsrGeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'csr:request
    ...
    {
        return  __DIR__ . '/../../stubs/files/backend/request.stub';
    }
